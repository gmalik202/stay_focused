...
class SecondPermisionScreen extends StatefulWidget {
  SecondPermisionScreen({Key? key, this.title}) : super(key: key);
...
class _LoginPageState extends State<SecondPermisionScreen> {
  @override
                    ...
                    decoration: new BoxDecoration(
                      // shape: BoxShape.circle,
                        image: new DecorationImage(
                          // fit: BoxFit.fill,
                            image: new AssetImage('assets/image/permission3.jpg')
                        )
                    )
                ),
                SizedBox(height: 52,),
                HeaderText("Usage Stats permission"),
                SizedBox(height: 19,),
                TitleText("Required for showing your phone usage"),
